...
> de la Serna, J. M. (2026). *Civilization Abm V2*. Universidad Internacional de La Rioja (UNIR).
> https://github.com/juanmoisesd/civilization-abm-v2 

See `CITATION.cff` for formatted references.

## Overview
This repository contains data and resources related to **civilization abm v2**. It is part of an open science initiative to share research findings and datasets with the global scientific community.
